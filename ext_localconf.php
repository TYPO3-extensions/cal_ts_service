...
t3lib_extMgm::addService($_EXTKEY,  'cal_event_model' /* sv type */,  'tx_cal_ts_service' /* sv key */,
	array(
		'title' => 'Cal Example Model', 'description' => '', 'subtype' => 'event',
		'available' => TRUE, 'priority' => 50, 'quality' => 50,
		'os' => '', 'exec' => '',
		'classFile' => t3lib_extMgm::extPath($_EXTKEY).'service/class.tx_cal_ts_service.php',
		'className' => 'tx_cal_ts_service',
	)
);

/* Cal ttnews category Model */
t3lib_extMgm::addService($_EXTKEY,  'cal_category_model' /* sv type */,  'tx_cal_ts_category_service' /* sv key */,
	array(
		'title' => 'Cal Example Model', 'description' => '', 'subtype' => 'category',
		'available' => TRUE, 'priority' => 50, 'quality' => 50,
		'os' => '', 'exec' => '',
		'classFile' => t3lib_extMgm::extPath($_EXTKEY).'service/class.tx_cal_ts_category_service.php',
		'className' => 'tx_cal_ts_category_service',
	)
);
?>